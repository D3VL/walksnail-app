...
export type Firmware = {
    changes: any[] | FirmwareChanges[];
    description?: string | null;
    downloads: any[] | FirmwareDownloads[];
    id: number;
    published: boolean;
    release_date: string;
    sort?: number | null;
...
export type FirmwareChanges = {
    description: string;
    firmware_id?: number | Firmware | null;
    id: number;
    sort?: number | null;
    type: string;
};

export type FirmwareDownloads = {
    file: string | DirectusFiles;
    firmware_id?: number | Firmware | null;
    id: number;
    logs: any[] | FirmwareDownloadsLog[];
    model: string;
    name?: string | null;
    sort?: number | null;
};
...
export type ProductsLinks = {
    ...
    retailer?: number | Retailers | null;
    sort?: number | null;
};
...
export type CustomDirectusTypes = {
    ...
    firmware: Firmware[];
    firmware_changes: FirmwareChanges[];
    firmware_downloads: FirmwareDownloads[];
    firmware_downloads_log: FirmwareDownloadsLog[];
    firmware_votes: FirmwareVotes[];
    products: Products[];
